...
public class DeleteContactThread extends AsyncTask<Contact, Void, List<Contact>> {

    private AppDatabase appDatabase;
    private ContactThread.ContactCallback contactCallback;

    public DeleteContactThread(AppDatabase appDatabase, ContactThread.ContactCallback contactCallback) {
    ...
    protected List<Contact> doInBackground(Contact... contacts) {
        for (Contact c : contacts) {
            appDatabase.contactDao().deleteContact(c);
        }

...
public class AddContactThread extends AsyncTask<Contact, Void, List<Contact>> {

    private AppDatabase appDatabase;
    private ContactThread.ContactCallback contactCallback;

    public AddContactThread(AppDatabase appDatabase, ContactThread.ContactCallback contactCallback) {
    ...
    protected List<Contact> doInBackground(Contact... contacts) {
        for (Contact c : contacts) {
            appDatabase.contactDao().InsertContact(c);
        }
